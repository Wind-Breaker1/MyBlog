<template>
  <div class="comment">
    <div class="comment-header">
      ...
      <el-input placeholder="请输入最多150字的评论..." v-model="context" class="input-with-select" type="textarea" size="mini" :maxlength="150" @focus="isShowReply(undefined)">
      </el-input>
      <el-button type="info" style="height:40px" @click="addComment(blogId, undefined)">评论</el-button>
    </div>
      ...
      <div class="first-comment">
        ...
        <div class="content">
          ...
          <div class="reply-comment" v-show="isShow === item._id">
            ...
            <el-button type="info" size="mini" class="reply-button" @click="addComment(item._id, item._id)">回复</el-button>
          </div>
          <!-- 次级评论 -->
          <div class="second-comment" v-for="reply in item.replyInfo" :key="reply._id">
            ...
            <div class="content">
              ...
              <div class="reply-comment" v-show="isShow === reply._id">
                ...
                <el-button type="info" size="mini" class="reply-button" @click="addComment(item._id, reply._id)">回复</el-button>
                </div>
              </div>
          </div>
        </div>
    ...
    <!-- 暂无评论的空状态 -->
    <el-empty description="暂无评论，期待您的评论" v-show="comment.length === 0"></el-empty>
  </div>
</template>
<script>
export default {
