	...
	<div class="article-box">
		<el-tabs tab-position="top" class="tabs" @tab-click="changeTab">
				...
				<el-table :data="jottings" class="table" height="100%">
					...
					<el-table-column label="操作" min-width="120">
						<template slot-scope="scope">
							...
							<el-button size="mini" type="success" @click="changeState(scope.row, 'jotting')">{{  scope.row.state ?
							"下架" : "发布"
			...
			<el-tab-pane label="评论管理" class="tab-content">
				<el-button type="primary" size="mini" @click="addItem('tag')" class="sub">新增书签</el-button>
				<el-table :data="comments" class="table" row-key="id" border
					...
					<el-table-column prop="articleName" label="所属文章" min-width="180">
					</el-table-column>
					<el-table-column prop="username" label="评论者" min-width="100">
					</el-table-column>
					<el-table-column label="操作" min-width="100">
						<template slot-scope="scope">
